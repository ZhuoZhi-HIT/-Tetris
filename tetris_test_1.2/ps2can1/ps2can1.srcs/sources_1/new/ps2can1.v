...
assign LED1=(ps2_asci==8'h41)? 1'b1:1'b0;//a
assign LED2=(ps2_asci==8'h42)? 1'b1:1'b0;//b
assign LED3=(ps2_asci==8'h43)? 1'b1:1'b0;//c
assign LED4=(ps2_asci==8'h44)? 1'b1:1'b0;//D
//initial
//begin
//LED1=0;
//LED2=0;
